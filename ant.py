...
from langchain_anthropic import ChatAnthropic  # Update with the correct import based on your langchain package
...
async def process_request(request: UserRequest):
    llm = ChatAnthropic(anthropic_api_key=anthropic_api_key, model_name="claude-3-opus-20240229")
